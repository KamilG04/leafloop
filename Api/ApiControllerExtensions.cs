...
public static class ApiControllerExtensions
{
    ...
    public static IActionResult ApiCreatedAtAction<T>( // ZMIANA: Zwraca IActionResult
        this ControllerBase controller, T data, string actionName, string controllerName, object routeValues,
        string? message = null)
    {
        var response = ApiResponse<T>.SuccessResponse(data, message ?? "Resource created successfully");
        ...
        this ControllerBase controller, ModelStateDictionary modelState)
    {
        ...
        return controller.BadRequest(ApiResponse.ErrorResponse("Validation failed. Please check the errors.",
            errorDictionary));
    }
        ...
        Exception? exception = null)
    {
        ...
        if (exception != null)
            devDetails = new
                { Type = exception.GetType().Name, Detail = exception.Message, StackTrace = exception.StackTrace };
#endif
